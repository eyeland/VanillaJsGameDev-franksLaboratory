window.addEventListener("load", function (e) {
  ...
  class Player {
    ...
    update(input, deltaTime, enemies) {
      // show controls on begin

      //collision detection
      enemies.forEach((enemy) => {
        const dx =
          enemy.x + enemy.width * 0.5 - 20 - (this.x + this.width * 0.5); //change her
        const dy =
  ...
  function displayControls(context) {
    if (showControls) {
      context.textAlign = "center";
      context.font = "40px Helvetica";
      context.fillStyle = "black";
      context.fillText("Swipe Up for Mobile.. Up arrow for Desktop ", 640, 50);
    }
  }
