...
export class SittingLeft extends State {
    ...
    handleInput(input){
        ...
        else if (input === 'RELEASE down') this.player.setState(states.STANDING_LEFT);// release down to stand
    }
}
export class SittingRight extends State {
    ...
    handleInput(input){
        ...
        if (input === 'PRESS right') this.player.setState(states.RUNNING_RIGHT)
        else if (input === 'RELEASE down') this.player.setState(states.STANDING_RIGHT); //release down to stand
    }
}
